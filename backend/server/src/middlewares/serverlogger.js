...
const rotating_file_stream_1 = tslib_1.__importDefault(require("rotating-file-stream"));
/**
 * Usage:
 *
 * Add...
...
class ServerLogger {
    constructor(config) {
        if (!ServerLogger.instance) {
            ServerLogger.instance = createLogger(config, morgan_1.default, rotating_file_stream_1.default);
        }

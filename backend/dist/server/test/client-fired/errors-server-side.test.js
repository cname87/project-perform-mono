...
const fireTestUrl = 'https://localhost:1337/testServer/errors/static/loadMocha.html';
...
describe('Server', () => {
    ...
    const runServerAndSetupSpies = async () => {
        ...
        spyErrorHandlerDebug = sinon.spy(index.appLocals.config.ERROR_HANDLERS, 'debug');
    };
                ...
                try {
                    switch (arg.message) {
                        ...
                        case 'Sent test end':
                            ...
                            expect(spyErrorHandlerDebug.calledWith('\\errorhandler.js: not sending a client ' +
                                'response as headers already sent')).to.be.true;
...
//# sourceMappingURL=errors-server-side.test.js.map
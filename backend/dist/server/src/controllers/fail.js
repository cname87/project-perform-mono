...
router.get('/', (req, res, next) => {
    ...
    async function asyncFail(_req, _res, _next) {
        ...
        await Promise.reject(createError(501, 'Testing trapped unhandled promise rejection'));
    }
    /* read url query */
    switch (req.query.fail) {
        ...
        case 'async':
            ...
            Promise.reject(new Error(modulename + ': Test unhandled promise rejection'));
            break;
        case 'crash':
